...
def get_distances(distances_df: pl.DataFrame) -> Tuple[pl.DataFrame, pl.DataFrame]:
...
def triplet_stats(triplets_df: pl.DataFrame):       
...
def generate_training_triplets() -> None:
    ...
    parquet_stats(triplets_df, cfg.output_parquet)
