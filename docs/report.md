---
title: "NAICS Hyperbolic Embedding System"
...
| Architecture | Multi-Channel → MoE → Lorentz Hyperbolic |
| Primary Loss | Decoupled Contrastive Learning (DCL) |
...
- Ge et al. (2023). Hyperbolic Contrastive Learning for Visual Representations.
