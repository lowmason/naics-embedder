...
def sample_naics_data(tmp_path):
    ...
    data = {
        'index': list(range(15)),
        'code': [
            '31', '311', '3111', '31111', '311111',  # Manufacturing - Food
            '32', '321', '3211', '32111', '321111',  # Manufacturing - Wood
            '44', '441', '4411', '44111', '441111',  # Retail - Motor vehicles
        ],
        'level': [2, 3, 4, 5, 6, 2, 3, 4, 5, 6, 2, 3, 4, 5, 6],
        'title': [
            'Manufacturing', 'Food Manufacturing', 'Animal Food Manufacturing',
            'Animal Food Manufacturing', 'Dog and Cat Food Manufacturing',
            'Manufacturing', 'Wood Product Manufacturing', 'Sawmills and Wood Preservation',
            'Sawmills and Wood Preservation', 'Sawmills',
            'Retail Trade', 'Motor Vehicle and Parts Dealers', 'Automobile Dealers',
